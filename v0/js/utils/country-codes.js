 ...
 * ISO 3166-1 alpha-3 codes with Chinese and English names
 * Extracted from old tool
 */
...
const COUNTRY_CODES = {
    ...
    'ATF': { name: '法屬南部和南極領地', nameEn: 'French Southern Territories' },
    ...
    'GLP': { name: '瓜德羅普', nameEn: 'Guadeloupe' },
    ...
    'HMD': { name: '赫德島和麥克唐納群島', nameEn: 'Heard Island and McDonald Islands' },
    ...
    'NCL': { name: '新喀里多尼亞島', nameEn: 'New Caledonia' },
    ...
    'NFK': { name: '諾福克群島', nameEn: 'Norfolk Island' },
    ...
    'SPM': { name: '聖比爾與密克隆群島', nameEn: 'Saint Pierre and Miquelon' },
    ...
    'SGS': { name: '南喬治亞島和南桑威奇群島', nameEn: 'South Georgia and the South Sandwich Islands' },
    ...
    'SJM': { name: '斯瓦巴和楊邁恩', nameEn: 'Svalbard and Jan Mayen' },
    ...
    'TKL': { name: '托克勞群島', nameEn: 'Tokelau' },
    'TON': { name: '東加', nameEn: 'Tonga' },
    'TTO': { name: '千里達及托巴哥', nameEn: 'Trinidad and Tobago' },
    'TUN': { name: '突尼西亞', nameEn: 'Tunisia' },
    'TUR': { name: '土耳其', nameEn: 'Turkiye' },
    'TKM': { name: '土庫曼', nameEn: 'Turkmenistan' },
    'TCA': { name: '土克凱可群島', nameEn: 'Turks and Caicos Islands' },
    'TUV': { name: '吐瓦魯', nameEn: 'Tuvalu' },
    'UGA': { name: '烏干達', nameEn: 'Uganda' },
    'UKR': { name: '烏克蘭', nameEn: 'Ukraine' },
    'ARE': { name: '阿聯', nameEn: 'United Arab Emirates' },
    'GBR': { name: '英國', nameEn: 'United Kingdom of Great Britain and Northern Ireland' },
    ...
    'WLF': { name: '瓦利斯群島和富圖那群島', nameEn: 'Wallis and Futuna' },
...
/**
 * Generate datalist HTML for country selection
 * @returns {string} HTML string for datalist
 */
function generateCountryDatalist() {
    let html = '';
    for (const [code, info] of Object.entries(COUNTRY_CODES)) {
        html += `<option value="${code}">${info.name} ${info.nameEn}</option>\n`;
    }
    return html;
}
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = { COUNTRY_CODES, generateCountryDatalist };
}
